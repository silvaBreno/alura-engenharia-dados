...
class Dados:
    ...
    def __transformando_dados_tabela_list_comprehension(self):    
        return [self.nome_colunas] + [[row.get(coluna, 'Indisponivel') for coluna in self.nome_colunas] for row in self.dados]
    ...
    def salvando_dados(self, path):
        ...
        dados_combinados_tabela = self.__transformando_dados_tabela_list_comprehension()
